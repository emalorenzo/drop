...
>(({ className, children, ...props }, ref) => (
	<NavigationMenuPrimitive.Root
		ref={ref}
		className={cn("flex relative z-10 flex-1 justify-center items-center max-w-max", className)}
		{...props}
	>
		{children}
...
>(({ className, ...props }, ref) => (
	<NavigationMenuPrimitive.List
		ref={ref}
		className={cn("flex flex-1 justify-center items-center space-x-1 list-none group", className)}
		{...props}
	/>
))
...
>(({ className, ...props }, ref) => (
	<div className={cn("flex absolute left-0 top-full justify-center")}>
